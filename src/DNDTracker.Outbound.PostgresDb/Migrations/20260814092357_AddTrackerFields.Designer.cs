...
namespace DNDTracker.Outbound.PostgresDb.Migrations
{
    ...
    [Migration("20260814092357_AddTrackerFields")]
    partial class AddTrackerFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DNDTracker.Vocabulary.Models.CampaignModel", b =>
                {
                    ...
                    b.Property<string>("MonsterLibraryJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("[]");
                    ...
                    b.Property<string>("SessionLogsJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("[]");

                    b.Property<string>("TimelineEntriesJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                        .HasDefaultValue("[]");
